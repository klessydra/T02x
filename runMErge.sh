...
then
	...
	cp -r $KLESS_PATH/klessydra-t0-2th $PULP_PATH/ips
	...
	# T02x patched files
	cp -f $KLESS_PATH/patched_files/t02x_patched_files/cmake_configure.klessydra-t0-2th.gcc.sh $PULP_PATH/sw
	cp -f $KLESS_PATH/patched_files/t02x_patched_files/vcompile_klessydra-t0-2th.csh $PULP_PATH/vsim/vcompile
